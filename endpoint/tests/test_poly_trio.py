...
class TestPolyTrioAPIViews(PolyTrioMixin, TestAPIViews):
...
class TestPolyTrioPassiveEndpoint(PolyTrioMixin, TestPassiveEndpoint):
    def setUp(self):
        super().setUp()
...
class PolyTrioTaskTestCase(PolyTrioMixin, TaskTestCase):
