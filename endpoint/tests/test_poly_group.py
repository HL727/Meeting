...
class TestGroupAPIViews(PolyGroupMixin, TestAPIViews):
...
class TestGroupPassiveEndpoint(PolyGroupMixin, TestPassiveEndpoint):
    def setUp(self):
        super().setUp()
...
class PolyGroupTaskTestCase(PolyGroupMixin, TaskTestCase):
